...
<body>
    ...
    <div class="cars_box">
        <div class="cars_subbox1"><h2><b>Hyundai Cars</b></h2></div>
            ...
            <?php if($result->num_rows>0)
                {
                    ...
                    <div class="cars_subbox2_items">
                        ...
                        <form action="">
                            <button type="submit" class="view"><a href="http://localhost/coding/car%20sellinng%20and%20buying/home_page/brands_page/hyundai/hyundai_car_view.php">View</a></button>
